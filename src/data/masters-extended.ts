...
export const ITEMS: Item[] = [
  { itemId: 'IT1', itemCode: 'RM-PVC-300C', itemName: 'PVC reel 300 µm clear, 620 mm deckle', itemType: 'RAW_MATERIAL', categoryId: 'CT2', uom: 'KG', purchaseUom: 'KG', conversionToStock: 1, standardRollWeightKg: 340, defaultSupplierId: 'SP1', defaultBinId: 'BN1', reorderLevel: 500, ratePerUom: 105, materialType: 'PVC', thicknessMicrons: 300, deckleWidthMm: 620, colour: 'Clear', minOrderQtyKg: 500, isFoodGrade: false, hsnCode: '39204900', status: 'ACTIVE', createdBy: BY, createdDate: ON },
  { itemId: 'IT2', itemCode: 'RM-PVC-450A', itemName: 'PVC reel 450 µm amber, 640 mm deckle', itemType: 'RAW_MATERIAL', categoryId: 'CT2', uom: 'KG', purchaseUom: 'KG', conversionToStock: 1, standardRollWeightKg: 520, defaultSupplierId: 'SP1', defaultBinId: 'BN1', reorderLevel: 400, ratePerUom: 112, materialType: 'PVC', thicknessMicrons: 450, deckleWidthMm: 640, colour: 'Amber', minOrderQtyKg: 400, isFoodGrade: false, hsnCode: '39204900', status: 'ACTIVE', createdBy: BY, createdDate: ON },
  { itemId: 'IT3', itemCode: 'RM-PET-250C', itemName: 'APET reel 250 µm clear, 600 mm deckle', itemType: 'RAW_MATERIAL', categoryId: 'CT3', uom: 'KG', purchaseUom: 'KG', conversionToStock: 1, standardRollWeightKg: 295, defaultSupplierId: 'SP3', defaultBinId: 'BN2', reorderLevel: 350, ratePerUom: 128, materialType: 'PET', thicknessMicrons: 250, deckleWidthMm: 600, colour: 'Clear', minOrderQtyKg: 350, isFoodGrade: true, hsnCode: '39206290', status: 'ACTIVE', createdBy: BY, createdDate: ON },
  { itemId: 'IT4', itemCode: 'RM-HIP-280W', itemName: 'HIPS reel 280 µm white, 620 mm deckle', itemType: 'RAW_MATERIAL', categoryId: 'CT1', uom: 'KG', purchaseUom: 'KG', conversionToStock: 1, standardRollWeightKg: 610, defaultSupplierId: 'SP2', defaultBinId: 'BN1', reorderLevel: 600, ratePerUom: 118, materialType: 'HIPS', thicknessMicrons: 280, deckleWidthMm: 620, colour: 'White', minOrderQtyKg: 600, isFoodGrade: true, hsnCode: '39031990', status: 'ACTIVE', createdBy: BY, createdDate: ON },
  { itemId: 'IT11', itemCode: 'RM-PP-400C', itemName: 'PP reel 400 µm clear, 620 mm deckle', itemType: 'RAW_MATERIAL', categoryId: 'CT1', uom: 'KG', purchaseUom: 'KG', conversionToStock: 1, standardRollWeightKg: 450, defaultSupplierId: 'SP4', defaultBinId: 'BN1', reorderLevel: 400, ratePerUom: 134, materialType: 'PP', thicknessMicrons: 400, deckleWidthMm: 620, colour: 'Clear', minOrderQtyKg: 400, isFoodGrade: true, hsnCode: '39202020', status: 'ACTIVE', createdBy: BY, createdDate: ON },
  { itemId: 'IT5', itemCode: 'PK-CTN-5PLY', itemName: 'Corrugated carton 5-ply, 450 × 350 × 300', itemType: 'PACKING', categoryId: 'CT4', uom: 'NOS', purchaseUom: 'NOS', conversionToStock: 1, defaultSupplierId: 'SP5', defaultBinId: 'BN5', reorderLevel: 400, ratePerUom: 68, hsnCode: '48191010', status: 'ACTIVE', createdBy: BY, createdDate: ON },
  { itemId: 'IT6', itemCode: 'PK-LDPE-BAG', itemName: 'LDPE liner bag 24 × 30 inch, 50 µm', itemType: 'PACKING', categoryId: 'CT4', uom: 'NOS', purchaseUom: 'BOX', conversionToStock: 500, defaultSupplierId: 'SP5', defaultBinId: 'BN5', reorderLevel: 2000, ratePerUom: 4.2, hsnCode: '39232100', status: 'ACTIVE', createdBy: BY, createdDate: ON },
  { itemId: 'IT7', itemCode: 'PK-TAPE-48', itemName: 'BOPP tape 48 mm × 65 m', itemType: 'PACKING', categoryId: 'CT4', uom: 'NOS', purchaseUom: 'BOX', conversionToStock: 72, defaultSupplierId: 'SP5', defaultBinId: 'BN5', reorderLevel: 100, ratePerUom: 32, hsnCode: '39191000', status: 'ACTIVE', createdBy: BY, createdDate: ON },
  { itemId: 'IT8', itemCode: 'CN-IPA-5L', itemName: 'Isopropyl alcohol, 5 litre can', itemType: 'CONSUMABLE', categoryId: 'CT5', uom: 'LTR', purchaseUom: 'CAN', conversionToStock: 5, defaultSupplierId: null, defaultBinId: 'BN6', reorderLevel: 20, ratePerUom: 240, hsnCode: '29051220', status: 'ACTIVE', createdBy: BY, createdDate: ON },
  { itemId: 'IT9', itemCode: 'SP-HTR-2KW', itemName: 'Ceramic heater element 2 kW, zone type', itemType: 'SPARE', categoryId: 'CT9', uom: 'NOS', purchaseUom: 'NOS', conversionToStock: 1, defaultSupplierId: null, defaultBinId: 'BN6', reorderLevel: 6, ratePerUom: 1850, hsnCode: '85164000', status: 'ACTIVE', createdBy: BY, createdDate: ON },
  { itemId: 'IT10', itemCode: 'SP-TC-K', itemName: 'K-type thermocouple, 1.5 m lead', itemType: 'SPARE', categoryId: 'CT9', uom: 'NOS', purchaseUom: 'NOS', conversionToStock: 1, defaultSupplierId: null, defaultBinId: 'BN6', reorderLevel: 10, ratePerUom: 620, hsnCode: '90251190', status: 'ACTIVE', createdBy: BY, createdDate: ON },
]
...
export const DOCUMENT_PREFIXES: DocumentPrefix[] = [
  ...
  { prefixId: 'PX11', documentKind: 'PURCHASE_REQUISITION', documentName: 'Purchase Requisition', prefix: 'PR', financialYear: FY, separator: '-', padding: 4, currentNumber: 52, resetsAnnually: true, status: 'ACTIVE', createdBy: BY, createdDate: '2026-04-01' },
  { prefixId: 'PX12', documentKind: 'PURCHASE_ORDER', documentName: 'Purchase Order', prefix: 'PO', financialYear: FY, separator: '-', padding: 4, currentNumber: 101, resetsAnnually: true, status: 'ACTIVE', createdBy: BY, createdDate: '2026-04-01' },
  { prefixId: 'PX13', documentKind: 'MATERIAL_ISSUE', documentName: 'Material Issue', prefix: 'MI', financialYear: FY, separator: '-', padding: 4, currentNumber: 316, resetsAnnually: true, status: 'ACTIVE', createdBy: BY, createdDate: '2026-04-01' },
  { prefixId: 'PX14', documentKind: 'RM_QC', documentName: 'RM QC Inspection', prefix: 'RMQC', financialYear: FY, separator: '-', padding: 4, currentNumber: 81, resetsAnnually: true, status: 'ACTIVE', createdBy: BY, createdDate: '2026-04-01' },
  { prefixId: 'PX15', documentKind: 'SUPPLIER_RETURN', documentName: 'Supplier Return Note', prefix: 'SRN', financialYear: FY, separator: '-', padding: 4, currentNumber: 12, resetsAnnually: true, status: 'ACTIVE', createdBy: BY, createdDate: '2026-04-01' },
  { prefixId: 'PX16', documentKind: 'NON_CONFORMANCE', documentName: 'Non-Conformance', prefix: 'NC', financialYear: FY, separator: '/', padding: 3, currentNumber: 5, resetsAnnually: true, status: 'ACTIVE', createdBy: BY, createdDate: '2026-04-01' },

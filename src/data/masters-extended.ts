...
export const ITEMS: Item[] = [
  { itemId: 'IT1', itemCode: 'RM-PVC-300C', itemName: 'PVC reel 300 µm clear, 620 mm deckle', itemType: 'RAW_MATERIAL', categoryId: 'CT2', uom: 'KG', defaultSupplierId: 'SP1', defaultBinId: 'BN1', reorderLevel: 500, ratePerUom: 105, hsnCode: '39204900', status: 'ACTIVE', createdBy: BY, createdDate: ON },
  { itemId: 'IT2', itemCode: 'RM-PVC-450A', itemName: 'PVC reel 450 µm amber, 640 mm deckle', itemType: 'RAW_MATERIAL', categoryId: 'CT2', uom: 'KG', defaultSupplierId: 'SP1', defaultBinId: 'BN1', reorderLevel: 400, ratePerUom: 112, hsnCode: '39204900', status: 'ACTIVE', createdBy: BY, createdDate: ON },
  { itemId: 'IT3', itemCode: 'RM-PET-250C', itemName: 'APET reel 250 µm clear, 600 mm deckle', itemType: 'RAW_MATERIAL', categoryId: 'CT3', uom: 'KG', defaultSupplierId: 'SP3', defaultBinId: 'BN2', reorderLevel: 350, ratePerUom: 128, hsnCode: '39206290', status: 'ACTIVE', createdBy: BY, createdDate: ON },
  { itemId: 'IT4', itemCode: 'RM-HIP-280W', itemName: 'HIPS reel 280 µm white, 620 mm deckle', itemType: 'RAW_MATERIAL', categoryId: 'CT1', uom: 'KG', defaultSupplierId: 'SP2', defaultBinId: 'BN1', reorderLevel: 600, ratePerUom: 118, hsnCode: '39031990', status: 'ACTIVE', createdBy: BY, createdDate: ON },
  { itemId: 'IT11', itemCode: 'RM-PP-400C', itemName: 'PP reel 400 µm clear, 620 mm deckle', itemType: 'RAW_MATERIAL', categoryId: 'CT1', uom: 'KG', defaultSupplierId: 'SP4', defaultBinId: 'BN1', reorderLevel: 400, ratePerUom: 134, hsnCode: '39202020', status: 'ACTIVE', createdBy: BY, createdDate: ON },
...
export const PROCESSES: Process[] = [
  ...
  { processId: 'PC3', processCode: 'PRC-030', processName: 'Punching and cutting', stage: 'PUNCHING', department: 'Production', machineType: 'PUNCHING', typeOfCharges: 'PER_PIECE', rate: 0.28, minimumCharges: 1200, setupCharges: 600, startUnit: 'SHEET', endUnit: 'PIECE', standardTimeMins: 160, processWastePercent: 1.0, toolRequired: true, requiresLineClearance: true, requiresFpa: true, sequenceNo: 3, status: 'ACTIVE', createdBy: BY, createdDate: ON },
  { processId: 'PC4', processCode: 'PRC-040', processName: 'Sorting and inspection', stage: 'PACKING', department: 'Quality', machineType: 'NONE', typeOfCharges: 'PER_PIECE', rate: 0.09, minimumCharges: 400, setupCharges: 0, startUnit: 'PIECE', endUnit: 'PIECE', standardTimeMins: 90, processWastePercent: 0.9, toolRequired: false, requiresLineClearance: false, requiresFpa: false, sequenceNo: 4, status: 'ACTIVE', createdBy: BY, createdDate: ON },
...
export const USERS: User[] = [
  ...
  { userId: 'U08', userCode: 'USR-025', userName: 'Dattatray More', loginUserName: 'dattatray.m', email: 'dattatray@desform.in', contactNo: '+91 91367 40023', designation: 'Punching Operator', role: 'OPERATOR', branch: 'Vasai', productionUnit: 'Unit-1', isAdmin: false, lastLoginAt: '2026-09-09 07:02', mustResetPassword: false, status: 'ACTIVE', createdBy: BY, createdDate: '2025-02-11' },
...
export const MODULES: AppModule[] = [
  ...
  { moduleId: 'M05', moduleCode: 'MOD-PNC', moduleName: 'Punching Entry', route: '/punching', moduleGroup: 'Production', enabled: true, rolePermissions: perms({ ADMIN: FULL, MANAGER: FULL, SUPERVISOR: EDIT, OPERATOR: EDIT, QC: P(true, false, false, true) }), status: 'ACTIVE', createdBy: 'System', createdDate: ON },

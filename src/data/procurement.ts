...
export const PURCHASE_ORDERS: PurchaseOrder[] = [
  ...
  },
  {
    ...
    poStatus: 'PART_RECEIVED', status: 'ACTIVE', createdBy: BY, createdDate: '2026-09-05',
    lines: [
      { lineId: 'PO2L1', itemId: 'IT4', prLineId: 'PR1L2', orderedQty: 900, receivedQty: 610, ratePerUom: 118, thicknessMicrons: 280, deckleWidthMm: 620 },
    ],
  },
  {
  ...
  },
  {
    ...
    lines: [
      { lineId: 'PO6L1', itemId: 'IT11', prLineId: null, orderedQty: 1800, receivedQty: 900, ratePerUom: 134, thicknessMicrons: 400, deckleWidthMm: 620 },
    ],
  },
  {
    ...
    poStatus: 'PART_RECEIVED', status: 'ACTIVE', createdBy: BY, createdDate: '2026-09-08',
    lines: [
      { lineId: 'PO5L1', itemId: 'IT2', prLineId: null, orderedQty: 1400, receivedQty: 520, ratePerUom: 112, thicknessMicrons: 450, deckleWidthMm: 640 },
    ],
  },
]
...
export const GRNS: GoodsReceiptNote[] = [
  {
    ...
    lines: [
      { lineId: 'G1L1', poLineId: 'PO1L1', itemId: 'IT1', challanQty: 340, receivedQty: 340, reelId: 'RL-9241', thicknessMicrons: 301, qcStatus: 'APPROVED', binId: 'BN1', qcRemarks: 'Within tolerance' },
      { lineId: 'G1L2', poLineId: 'PO1L1', itemId: 'IT1', challanQty: 860, receivedQty: 860, reelId: null, thicknessMicrons: 300, qcStatus: 'APPROVED', binId: 'BN1', qcRemarks: 'Balance of the order, three rolls' },
    ],
  },
  {
    ...
    lines: [
      { lineId: 'G2L1', poLineId: 'PO2L1', itemId: 'IT4', challanQty: 610, receivedQty: 610, reelId: 'RL-9253', thicknessMicrons: 279, qcStatus: 'APPROVED', binId: 'BN1', qcRemarks: 'Within tolerance' },
    ],
  },
  {
    ...
    lines: [
      { lineId: 'G3L1', poLineId: 'PO4L1', itemId: 'IT3', challanQty: 295, receivedQty: 295, reelId: 'RL-9247', thicknessMicrons: 243, qcStatus: 'QUARANTINE', binId: 'BN2', qcRemarks: 'Gauge 243 against 250 ordered, held for supplier decision' },
      { lineId: 'G3L2', poLineId: 'PO4L1', itemId: 'IT3', challanQty: 380, receivedQty: 380, reelId: 'RL-9258', thicknessMicrons: 598, qcStatus: 'QUARANTINE', binId: 'BN2', qcRemarks: 'Wrong gauge supplied, 598 against 250' },
    ],
  },
  {
    ...
    status: 'ACTIVE', createdBy: BY, createdDate: '2026-09-07',
    lines: [
      { lineId: 'G4L1', poLineId: 'PO4L1', itemId: 'IT3', challanQty: 260, receivedQty: 260, reelId: 'RL-9248', thicknessMicrons: 176, qcStatus: 'REJECTED', binId: 'BN3', qcRemarks: 'Below the 180 micron plant floor, return to supplier' },
    ],
  },
  {
    ...
    status: 'ACTIVE', createdBy: BY, createdDate: '2026-09-08',
    lines: [
      { lineId: 'G5L1', poLineId: 'PO5L1', itemId: 'IT2', challanQty: 520, receivedQty: 520, reelId: 'RL-9251', thicknessMicrons: 452, qcStatus: 'APPROVED', binId: 'BN1', qcRemarks: 'Within tolerance' },
    ],
  },
  {
    ...
    lines: [
      { lineId: 'G6L1', poLineId: 'PO6L1', itemId: 'IT11', challanQty: 900, receivedQty: 900, reelId: 'RL-9256', thicknessMicrons: 401, qcStatus: 'APPROVED', binId: 'BN1', qcRemarks: 'Within tolerance' },
    ],
  },
  {
    ...
    lines: [
      { lineId: 'G7L1', poLineId: 'PO3L1', itemId: 'IT5', challanQty: 800, receivedQty: 800, reelId: null, thicknessMicrons: null, qcStatus: 'APPROVED', binId: 'BN5', qcRemarks: 'Count verified against the challan' },
      { lineId: 'G7L2', poLineId: 'PO3L2', itemId: 'IT7', challanQty: 240, receivedQty: 240, reelId: null, thicknessMicrons: null, qcStatus: 'APPROVED', binId: 'BN5', qcRemarks: 'Count verified against the challan' },
    ],
  },
]
...
/**
 * Receipts are generated from the GRN lines that IQC approved, so nothing can
 * appear in a bin without a goods receipt behind it. Issues and returns are
 * booked separately as the floor consumes material.
 */
const RECEIPTS: StockMovement[] = GRNS.flatMap((grn) =>
  grn.lines
    .filter((line) => line.qcStatus === 'APPROVED' && line.binId)
    .map((line, i) => ({
